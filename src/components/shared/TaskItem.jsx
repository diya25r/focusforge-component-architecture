export default function TaskItem({ task, onToggle, onDelete }) {
  return (
    <div style={{ background: "#1a1a2e", border: `1px solid ${task.completed ? "#1e3a2e" : "#2d2d44"}`, borderRadius: 12, padding: "14px 18px", display: "flex", alignItems: "center", gap: 14, transition: "border-color 0.2s", opacity: task.completed ? 0.6 : 1 }}>
      <button
        onClick={onToggle}
